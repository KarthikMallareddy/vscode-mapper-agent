...
export function activate(context: vscode.ExtensionContext) {
    ...
    modelName: "gemini-1.5-flash", // Use modelName for better compatibility in some versions
    apiKey: apiKey,
    apiVersion: "v1", // Stable production endpoint
});

       // This will print every model your API key can actually see to the Debug Console
        const available = await model.getApiClient().listModels();
        console.log("Allowed Models:", available);
