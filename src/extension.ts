                ...
                (async () => {
                    try {
                        ...
                        async function renderView(viewId, pushStack) {
                            ...
                            var prettyNames = { overview: 'Architecture Overview', frontend: 'Frontend', backend: 'Backend / API', datastore: 'Data Store', external: 'External Services', modules: 'Module Import Map' };
